...
make_histogram_pre <- function(district="MUN",precint=1, data="age"){
...
make_histogram_pre("MUN",67,"income")

return_median_pre <- function(district="MUN",precint=1, data="age"){
...
return_median_pre("MUN",67,"income")